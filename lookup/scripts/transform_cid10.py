...
OUTPUT_FILENAME = "tabela_cid10.parquet"
...
cid_final = cid_final.rename(columns={"DESCRICAO":"descricao"})
...
cid_final.to_parquet(OUTPUT_PATH + "/" + OUTPUT_FILENAME,engine="pyarrow",index=False)